...
START_TEST(test_block_symbol_table) {
    ...
    struct type *ti64 = testsupport_analyzer_type_create_simple_elementary(ELEMENTARY_TYPE_INT_64);
    struct type *tu32 = testsupport_analyzer_type_create_simple_elementary(ELEMENTARY_TYPE_UINT_32);
...
START_TEST(test_fndecl_symbol_table) {
    ...
    struct type *tu64 = testsupport_analyzer_type_create_simple_elementary(ELEMENTARY_TYPE_UINT_64);
    struct type *tstring = testsupport_analyzer_type_create_simple_elementary(ELEMENTARY_TYPE_STRING);
    struct type *tu32 = testsupport_analyzer_type_create_simple_elementary(ELEMENTARY_TYPE_UINT_32);
...
START_TEST(test_typedecl_symbol_table) {
    ...
    testsupport_analyzer_prepare();
    struct type *tstring = testsupport_analyzer_type_create_simple_elementary(ELEMENTARY_TYPE_STRING);
    struct type *tu16 = testsupport_analyzer_type_create_simple_elementary(ELEMENTARY_TYPE_UINT_16);
...
START_TEST(test_multiple_level_symbol_tables) {
    ...
    struct type *ti8 = testsupport_analyzer_type_create_simple_elementary(ELEMENTARY_TYPE_INT_8);
    struct type *tu64 = testsupport_analyzer_type_create_simple_elementary(ELEMENTARY_TYPE_UINT_64);
    ck_assert(analyzer_first_pass(front_testdriver_module()));
